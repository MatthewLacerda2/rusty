...
//! (runtime init / script load / live-state), `lifecycle` (the
//! start/update/trigger/eval callbacks + REPL value rendering) and `callbacks`
//! (the lifecycle-callback names, kept public and namespaced) — and re-exported
