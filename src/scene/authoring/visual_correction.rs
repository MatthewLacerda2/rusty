...
use crate::components::{Entity, Tonemap};
...
pub fn set_bloom_active(entity: &mut Entity, active: bool) {
    if let Some(vc) = &mut entity.visual_correction {
...
pub fn set_bloom_intensity(entity: &mut Entity, value: f32) {
    if let Some(vc) = &mut entity.visual_correction {
...
pub fn set_bloom_threshold(entity: &mut Entity, value: f32) {
    if let Some(vc) = &mut entity.visual_correction {
...
/// Set the exposure (EV).
pub fn set_exposure(entity: &mut Entity, value: f32) {
    if let Some(vc) = &mut entity.visual_correction {
        vc.exposure = value;
    }
}
...
/// Set the contrast.
pub fn set_contrast(entity: &mut Entity, value: f32) {
    if let Some(vc) = &mut entity.visual_correction {
        vc.contrast = value;
    }
}
...
/// Set the saturation.
pub fn set_saturation(entity: &mut Entity, value: f32) {
    if let Some(vc) = &mut entity.visual_correction {
        vc.saturation = value;
    }
}
...
pub fn set_gamma(entity: &mut Entity, value: f32) {
    if let Some(vc) = &mut entity.visual_correction {
...
pub fn set_tonemap(entity: &mut Entity, tonemap: Tonemap) {
    if let Some(vc) = &mut entity.visual_correction {
        vc.tonemap = tonemap;
    }
}
...
pub fn set_ssr_active(entity: &mut Entity, active: bool) {
    if let Some(vc) = &mut entity.visual_correction {
...
pub fn set_ssr_quality(entity: &mut Entity, quality: String) {
    if let Some(vc) = &mut entity.visual_correction {
...
pub fn set_ssr_temporal_upsampling(entity: &mut Entity, on: bool) {
    if let Some(vc) = &mut entity.visual_correction {
...
mod tests {
    ...
    fn ops_write_through_with_clamps() {
        ...
        let vc = e.visual_correction.as_ref().unwrap();
