...
use crate::core::scene::{Entity, LightComponent, LightType, Scene};
...
impl Renderer {
    ...
    fn create_default_checkerboard_texture(
        device: &wgpu::Device,
        queue: &wgpu::Queue,
